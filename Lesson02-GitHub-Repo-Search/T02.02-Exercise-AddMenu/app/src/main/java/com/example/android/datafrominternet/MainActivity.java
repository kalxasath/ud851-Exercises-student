...
public class MainActivity extends AppCompatActivity {
    ...
    // Do 2 - 7 in menu.xml ///////////////////////////////////////////////////////////////////////
    // COPLETED (2) Create a menu xml called 'main.xml' in the res->menu folder
    // COPLETED (3) Add one menu item to your menu
    // COPLETED (4) Give the menu item an id of @+id/action_search
    // COPLETED (5) Set the orderInCategory to 1
    // COPLETED (6) Show this item if there is room (use app:showAsAction, not android:showAsAction)
    // COPLETED (7) Set the title to the search string ("Search") from strings.xml
    // Do 2 - 7 in menu.xml ///////////////////////////////////////////////////////////////////////
