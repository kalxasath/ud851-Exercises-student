...
public class MainActivity extends AppCompatActivity {
    ...
    static final String SEARCH_QUERY_KEY = "query";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    static final String SEARCH_RESULTS_KEY = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mUrlDisplayTextView.setText(savedInstanceState.getString(SEARCH_QUERY_KEY));
